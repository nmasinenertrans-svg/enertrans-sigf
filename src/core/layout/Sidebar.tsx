...
const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: ROUTE_PATHS.repairsImport, label: 'Importar planilla de reparaciones (prueba)', module: 'REPAIRS', devOnly: true },
  ...
  },
  {
    ...
    items: [
      ...
      { path: ROUTE_PATHS.trips, label: 'Viajes / Traslados (prueba)', module: 'DELIVERIES', devOnly: true },
    ],
  },
  {
    id: 'system',
