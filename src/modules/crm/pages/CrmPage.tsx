  ...
  return (
    <section className="space-y-5">
      ...
      <section className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        <article className="rounded-xl border border-blue-200 bg-white p-4 shadow-sm"><p className="text-xs text-blue-600">Tasa de éxito</p><p className="text-xl font-bold text-blue-900">{kpis.winRate}%</p></article>
