...
export const InventoryStockCard = ({
  ...
  <div className="grid gap-3 md:grid-cols-4">
    ...
    <article className="rounded-xl border border-sky-200 bg-sky-50 p-4 shadow-sm">
      <p className="text-xs font-semibold uppercase tracking-wide text-sky-700">Vinculados a OT</p>
      <p className="mt-2 text-2xl font-bold text-sky-800">{linkedToWorkOrders}</p>
    </article>
  </div>
)
