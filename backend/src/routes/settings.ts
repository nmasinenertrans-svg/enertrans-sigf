...
const featureFlagsSchema = z.object({
  ...
  showClientsModule: z.boolean().optional(),
  showDeliveriesModule: z.boolean().optional(),
  ...
  showSuppliersModule: z.boolean().optional(),
  showCrmModule: z.boolean().optional(),
  ...
  basicViewMode: z.boolean().optional(),
})
